	...
	<div class="form-row">
		...
		<div class="content">
			<form name="form1" method="post" action="adminIndex.php">
				<h3>Accounts</h3>
				<a href='add_user.php' id="wew" target="_blank" onclick="window.open('add_user.php','pagename','resizable,height=1000,width=540'); return false;">Add Account</a>
                <div class="table-responsive">
					...
					<tbody>
						...
						{ 
							...
							<tr>
								<td>
								<a href='update_user.php' target="_blank" onclick="window.open('update_user.php?id=<?php echo $row['id'] ?>'); return false;"><img src="images2/icon_view.png" height='18px'></a>
								 |
